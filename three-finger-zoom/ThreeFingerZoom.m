...
#pragma mark - Приватный MultitouchSupport.framework
...
extern void MTRegisterContactFrameCallback(MTDeviceRef device, MTContactCallback callback);
extern void MTDeviceStart(MTDeviceRef device, int unused);
